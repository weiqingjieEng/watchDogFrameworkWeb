...
//     },
//     children:[
//       { path: 'graph',meta:{icon: 'ios-compass-outline', title: '力导向关系图',access: ['charts:graph']}, name: 'charts_graph', component: () => import('@/view/charts/graph') },
...
const  a  = function(){
  try {
    let res = post('/system/resource/list')
  } catch (error) {
    this.$throw(error)
  }
