<template>
  <div class="searchInput">
    <Row>
      <Col span="8" push="4">
        <Input v-model="searchText"  @keydown.down.prevent.native='down()' @keydown.up.prevent.native='up()' placeholder="请输入搜索条件...">
...
export default {
   ...
   methods: {
     ...
     show: function (ev) {
      ...
      //   this.$throw(error)
      // }
      this.getInputList(param).then((res) => {
        this.result = res
      })
    },
    down: function() {
