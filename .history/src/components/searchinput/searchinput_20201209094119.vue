  ...
  <div class="searchInput">
    <Row>
      <Col span="8" push="4">
        ...
        <List class="inputUl" v-if="result.length!==0">
          <!-- <ListItem v-for="(item, index) in result" :class='{bg: index===nowIndex}' :key='index' @mouseover="changebg($event)" @click="getClickData($event)">
            {{item[getselectValue()]}}
          </ListItem> -->
        </List>
      </Col>
