...
export default {
  ...
  methods: {
    ...
    arrangedata:function () {
      ...
      let companyNodes = {name: this.sourcedata.companyName, category: category, symbolSize: randomSize(50, 80),itemStyle: { color: companyColor},label: {color: '#000000'} }
